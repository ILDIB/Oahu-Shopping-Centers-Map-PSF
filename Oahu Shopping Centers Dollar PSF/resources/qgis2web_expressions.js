...
function exp_ShoppingCenters_1rule0_eval_expression(context) {
    // "$PSFlandvalued" >= 70

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('$PSFlandvalued')  >= 70);
    } else {
        return (feature.get('$PSFlandvalued')  >= 70);
    }
}
...
function exp_ShoppingCenters_1rule1_eval_expression(context) {
    // "$PSFlandvalued" < 70
